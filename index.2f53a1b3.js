 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _i(e,t,i=!1){const n=await Ot(e,t._linkToIdToken(e.auth,await e.getIdToken()),i);return Ii._forOperation(e,"link",n)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Li(e,t,i=!1){const n="signIn",r=await Si(e,n,t),a=await Ii._fromIdTokenResponse(e,n,r);return i||await e._updateCurrentUser(a.user),a}async function Ai(e,t){return Li(ni(e),t)}async function Oi(e,t,i){const n=ni(e),r=await Ti(n,{returnSecureToken:!0,email:t,password:i}),a=await Ii._fromIdTokenResponse(n,"signIn",r);return await n._updateCurrentUser(a.user),a}function Mi(e,t,i){return Ai(Z(e),gi.credential(t,i))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tn=new vt(3e4,6e4);function In(){const e=Fi().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let En=null;function Cn(e){return En=En||function(e){return new Promise(((t,i)=>{var n,r,a;function s(){In(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{In(),i(at(e,"network-request-failed"))},timeout:Tn.get()})}if(null===(r=null===(n=Fi().gapi)||void 0===n?void 0:n.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(a=Fi().gapi)||void 0===a?void 0:a.load)){const t=Qi("iframefcb");return Fi()[t]=()=>{gapi.load?s():i(at(e,"network-request-failed"))},Ji(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>i(e)))}s()}})).catch((e=>{throw En=null,e}))}(e),En}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
