 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name="FirebaseError",Object.setPrototypeOf(this,S.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,_.prototype.create)}}class _{create(e,...t){const i=t[0]||{},n=`${this.service}/${e}`,r=this.errors[e],s=r?function(e,t){return e.replace(N,((e,i)=>{const n=t[i];return null!=n?String(n):`<${i}?>`}))}(r,i):"Error",a=`${this.serviceName}: ${s} (${n}).`;return new S(n,a,i)}constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}}const N=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ie(e,t={}){let i=e;if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=n.name;if("string"!=typeof r||!r)throw ke.create("bad-app-name",{appName:String(r)});var s;if(i||(i=null===(s=E())||void 0===s?void 0:s.config),!i)throw ke.create("no-options");const a=ve.get(r);if(a){if(A(i,a.options)&&A(n,a.config))return a;throw ke.create("duplicate-app",{appName:r})}const o=new $(r);for(const e of be.values())o.addComponent(e);const l=new Ee(i,n,o);return ve.set(r,l),l}function Te(e="[DEFAULT]"){const t=ve.get(e);if(!t&&"[DEFAULT]"===e)return Ie();if(!t)throw ke.create("no-app",{appName:e});return t}function Ce(e,t,i){var n;let r=null!==(n=ge[e])&&void 0!==n?n:e;i&&(r+=`-${i}`);const s=r.match(/\s|\//),a=t.match(/\s|\//);if(s||a){const e=[`Unable to register library "${r}" with version "${t}":`];return s&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void me.warn(e.join(" "))}xe(new F(`${r}-version`,(()=>({library:r,version:t})),"VERSION"))}let Se=null;function _e(){return Se||(Se=ce("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw ke.create("idb-open",{originalErrorMessage:e.message})}))),Se}async function Ne(e,t){try{const i=(await _e()).transaction("firebase-heartbeat-store","readwrite"),n=i.objectStore("firebase-heartbeat-store");return await n.put(t,Le(e)),i.done}catch(e){if(e instanceof S)me.warn(e.message);else{const t=ke.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});me.warn(t.message)}}}function Le(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var De;De="",xe(new F("platform-logger",(e=>new fe(e)),"PRIVATE")),xe(new F("heartbeat",(e=>new Ae(e)),"PRIVATE")),Ce("@firebase/app","0.9.0",De),Ce("@firebase/app","0.9.0","esm2017"),Ce("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function St(e,t,i){return`firebase:${e}:${t}:${i}`}class _t{setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?It._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();return await this.removeCurrentUser(),this.persistence=e,t?this.setCurrentUser(t):void 0}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new _t(Qe(Ct),e,i);const n=(await Promise.all(t.map((async e=>{if(await e._isAvailable())return e})))).filter((e=>e));let r=n[0]||Qe(Ct);const s=St(i,e.config.apiKey,e.name);let a=null;for(const i of t)try{const t=await i._get(s);if(t){const n=It._fromJSON(e,t);i!==r&&(a=n),r=i;break}}catch(e){}const o=n.filter((e=>e._shouldAllowMigration));return r._shouldAllowMigration&&o.length?(r=o[0],a&&await r._set(s,a.toJSON()),await Promise.all(t.map((async e=>{if(e!==r)try{await e._remove(s)}catch(e){}}))),new _t(r,e,i)):new _t(r,e,i)}constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:n,name:r}=this.auth;this.fullUserKey=St(this.userKey,n.apiKey,r),this.fullPersistenceKey=St("persistence",n.apiKey,r),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ft(e,t=[]){let i;switch(e){case"Browser":i=Nt(b());break;case"Worker":i=`${Nt(b())}-${e}`;break;default:i=e}return`${i}/JsCore/9.15.0/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
class Fi{verifyPhoneNumber(e,t){return Wi(this.auth,e,W(t))}static credential(e,t){return ei._fromVerification(e,t)}static credentialFromResult(e){const t=e;return Fi.credentialFromTaggedObject(t)}static credentialFromError(e){return Fi.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{phoneNumber:t,temporaryProof:i}=e;return t&&i?ei._fromTokenResponse(t,i):null}constructor(e){this.providerId=Fi.PROVIDER_ID,this.auth=Ht(e)}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ui(e,t){return t?Qe(t):(qe(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Fi.PROVIDER_ID="phone",Fi.PHONE_SIGN_IN_METHOD="phone";class $i extends qt{_getIdTokenResponse(e){return Jt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Jt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Jt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function Hi(e){return gi(e.auth,new $i(e),e.bypassAuthState)}function ji(e){const{auth:t,user:i}=e;return qe(i,t,"internal-error"),mi(i,new $i(e),e.bypassAuthState)}async function Vi(e){const{auth:t,user:i}=e;return qe(i,t,"internal-error"),fi(i,new $i(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cn=new nt(3e4,6e4);function dn(){const e=_i().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let un=null;function pn(e){return un=un||function(e){return new Promise(((t,i)=>{var n,r,s;function a(){dn(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{dn(),i(Ve(e,"network-request-failed"))},timeout:cn.get()})}if(null===(r=null===(n=_i().gapi)||void 0===n?void 0:n.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=_i().gapi)||void 0===s?void 0:s.load)){const t=Bi("iframefcb");return _i()[t]=()=>{gapi.load?a():i(Ve(e,"network-request-failed"))},zi(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>i(e)))}a()}})).catch((e=>{throw un=null,e}))}(e),un}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${M(o).slice(1)}`}const wn=class{async _openPopup(e,t,i,n){var r;Ye(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return yn(e,xn(e,t,i,Ze(),n),Ci())}async _openRedirect(e,t,i,n){var r;return await this._originValidation(e),r=xn(e,t,i,Ze(),n),_i().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:i}=this.eventManagers[t];return e?Promise.resolve(e):(Ye(i,"If manager is not set, promise should be"),i)}const i=this.initAndGetManager(e);return this.eventManagers[t]={promise:i},i.catch((()=>{delete this.eventManagers[t]})),i}async initAndGetManager(e){const t=await async function(e){const t=await pn(e),i=_i().gapi;return qe(i,e,"internal-error"),t.open({where:document.body,url:gn(e),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:fn,dontclear:!0},(t=>new Promise((async(i,n)=>{await t.restyle({setHideOnLeave:!1});const r=Ve(e,"network-request-failed"),s=_i().setTimeout((()=>{n(r)}),hn.get());function a(){_i().clearTimeout(s),i(t)}t.ping(a).then(a,(()=>{n(r)}))}))))}(e),i=new tn(e);return t.register("authEvent",(t=>{qe(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:i.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=t,i}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(i=>{var n;const r=null===(n=null==i?void 0:i[0])||void 0===n?void 0:n.webStorageSupport;void 0!==r&&t(!!r),je(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=on(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Wt()||At()||zt()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ii,this._completeRedirectFn=en,this._overrideRedirectResult=Ji}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
