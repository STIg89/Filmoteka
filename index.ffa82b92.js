 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var De;De="",xe(new U("platform-logger",(e=>new fe(e)),"PRIVATE")),xe(new U("heartbeat",(e=>new Ae(e)),"PRIVATE")),Te("@firebase/app","0.9.0",De),Te("@firebase/app","0.9.0","esm2017"),Te("fire-js","");
/**
 * @license
